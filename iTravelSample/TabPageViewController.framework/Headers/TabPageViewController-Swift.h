...
SWIFT_CLASS("_TtC21TabPageViewController21TabPageViewController")
@interface TabPageViewController : UIPageViewController
@property (nonatomic) BOOL isInfinity;
+ (TabPageViewController * _Nonnull)create SWIFT_WARN_UNUSED_RESULT;
- (void)viewDidLoad;
...
@interface TabPageViewController (SWIFT_EXTENSION(TabPageViewController)) <UIScrollViewDelegate>
...
@interface TabPageViewController (SWIFT_EXTENSION(TabPageViewController)) <UIPageViewControllerDelegate>
...
@interface TabPageViewController (SWIFT_EXTENSION(TabPageViewController)) <UIPageViewControllerDataSource>
